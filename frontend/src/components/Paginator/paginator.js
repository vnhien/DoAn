...
export default class Paginator extends React.Component {
            ...
            <div className="paging" style={{ position: "relative" }}>
                <nav aria-label="Page navigation">
                    <ul className="pagination">
                        ...
                        <li className="page-item">
                            <a className={'page-link ' + ((currentPage >= lastPage) ? 'disable' : '')} value={currentPage + 2} onClick={e => this.changePage(e)}  >&#10095;&#10095;</a>
                        </li>
                    </ul >
                </nav >
            </div >
    ...
    componentDidMount = async () => {
        let pagination = await this.props.getData(this.props.pagination.currentPage)
